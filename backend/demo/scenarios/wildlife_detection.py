"""
Wildlife and Wildfire Detection Scenario
Simulates wildlife and wildfire detection across camera network
"""
...
class WildlifeDetectionScenario:
    """Wildlife and wildfire detection demo scenario"""
    ...
    async def start(self):
        """Start the wildlife detection scenario"""
        if self.running:
            return
        ...
        await self.connection_manager.broadcast({
            ...
            "scenario": "wildlife_detection",
            "message": "Wildlife and wildfire detection scenario started - monitoring area",
    ...
    async def _run_scenario(self):
        """Run the wildlife detection scenario sequence"""
        try:
            # Wait a moment before starting
            await asyncio.sleep(2)
            
            # Sequence of detections across different cameras
            # Can be wildlife or wildfire
            sequence = [
                {"camera": "cam_001", "delay": 3, "activity_type": "wildlife_detected", "confidence": 0.75},
                {"camera": "cam_002", "delay": 8, "activity_type": "wildlife_bear", "confidence": 0.82},
                {"camera": "cam_003", "delay": 6, "activity_type": "wildfire", "confidence": 0.88},
            ]
            ...
            if self.running:
                ...
                await self.connection_manager.broadcast({
                    ...
                    "message": "Pattern detected: Wildlife and wildfire activity detected across monitoring area",
